...
%>
	...
	<table border="1" align="center">
	 	<tr>
			<td colspan="2" style="background-color: white;"><h1>회원정보 수정</h1></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="background-color: white;"><input type="email" name="email" required="required" value="<%=cvo.getEmail() %>"></td>
		</tr>
		<tr>
			<td style="background-color: aqua;">전화번호</td>
			<td style="background-color: white;"><input type="tel" name="tel" required="required" value="<%=cvo.getTel() %>"></td>
		</tr>
		<tr>
			<td style="background-color: aqua;">비밀번호</td>
			<td style="background-color: white;"><input type="password" required="required" name="password"></td>
		</tr>
		<tr>
			<td colspan="2" style="background-color: white;">
				<input style="font-size: 20px" type="hidden" name="id" value="<%=id%>">
				<input style="font-size: 20px" type="submit" value="회원정보수정" >
